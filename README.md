...
* ThirdseqExpv2_Normalized_AO_MO_Model_Data_mu025_Sig4Ident_batchsize4_L_05_1_2_S_05_1_2_nrb_1000_ntp_50.csv: This contains summary statistics and D-errors of 1000 randomly generated batch designs (of size 4) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning frameworks discussed in Section 3.3 in the (balanced) <span style='color: red;'>LOW</span> signal-to-noise ratio regime. Used for determining parameters for MIP-AC and MIP-MC.
* ThirdseqExpv2_Normalized_AO_MO_Model_Data_mu1_Sig1Ident_batchsize4_L_05_1_2_S_05_1_2_nrb_1000_ntp_50.csv: This contains summary statistics and D-errors of 1000 randomly generated batch designs (of size 4) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning frameworks discussed in Section 3.3 in the (balanced) <span style='color: green;'>MEDIUM</span> signal-to-noise ratio regime. Used for determining parameters for MIP-AC and MIP-MC.
* ThirdseqExpv2_Normalized_AO_MO_Model_Data_mu4_Sig025Ident_batchsize4_L_05_1_2_S_05_1_2_nrb_1000_ntp_50.csv: This contains summary statistics and D-errors of 1000 randomly generated batch designs (of size 4) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning frameworks discussed in Section 3.3 in the (balanced) <span style='color: blue;'>HIGH</span> signal-to-noise ratio regime. Used for determining parameters for MIP-AC and MIP-MC.
* Normalized_OS_Model_Data_mu025_Sig4Ident_batchsize1_L_05_1_2_S_05_1_2_nrb_500_ntp_50_expIIIv2.csv: This contains summary statistics and D-errors of 500 randomly gnerated questions (batch of size 1) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning framework discussed in Section 3.3 in the (balanced) LOW signal-to-noise ratio regime. Used for determining parameters for OS (onestep lookahead).
* Normalized_OS_Model_Data_mu1_Sig1Ident_batchsize1_L_05_1_2_S_05_1_2_nrb_500_ntp_50_expIIIv2.csv: This contains summary statistics and D-errors of 500 randomly gnerated questions (batch of size 1) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning framework discussed in Section 3.3 in the (balanced) MEDIUM signal-to-noise ratio regime. Used for determining parameters for OS (onestep lookahead).
* Normalized_OS_Model_Data_mu4_Sig025Ident_batchsize1_L_05_1_2_S_05_1_2_nrb_500_ntp_50_expIIIv2.csv: This contains summary statistics and D-errors of 500 randomly gnerated questions (batch of size 1) under the different distributions $N(l \mu, s \Sigma) for $l \in L$ and $s \in S$ used as data for the offline learning framework discussed in Section 3.3 in the (balanced) HIGH signal-to-noise ratio regime. Used for determining parameters for OS (onestep lookahead).
